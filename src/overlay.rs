...
pub fn get_layout_spec(layout: &str) -> LayoutSpec {
    match layout {
        "question_answer" => LayoutSpec {
            title: LayoutParam { x: 105.0, y: 500.0, width: 870.0, align: "center".to_string(), font_size: 70.0 },
            point: LayoutParam { x: 145.0, y: 825.0, width: 790.0, align: "center".to_string(), font_size: 48.0 },
        ...
        "left_stack" => LayoutSpec {
            title: LayoutParam { x: 92.0, y: 350.0, width: 820.0, align: "left".to_string(), font_size: 66.0 },
            point: LayoutParam { x: 105.0, y: 710.0, width: 850.0, align: "left".to_string(), font_size: 44.0 },
            point_offset_y: 118.0,
            cta: LayoutParam { x: 105.0, y: 1510.0, width: 850.0, align: "left".to_string(), font_size: 30.0 },
            marker: "- ".to_string(),
        },
        "right_stack" => LayoutSpec {
            title: LayoutParam { x: 155.0, y: 680.0, width: 820.0, align: "right".to_string(), font_size: 64.0 },
            point: LayoutParam { x: 155.0, y: 930.0, width: 820.0, align: "right".to_string(), font_size: 42.0 },
            point_offset_y: 108.0,
            cta: LayoutParam { x: 155.0, y: 1510.0, width: 820.0, align: "right".to_string(), font_size: 30.0 },
            marker: "".to_string(),
        },
        "list_style" => LayoutSpec {
            title: LayoutParam { x: 90.0, y: 340.0, width: 900.0, align: "left".to_string(), font_size: 64.0 },
            point: LayoutParam { x: 110.0, y: 690.0, width: 850.0, align: "left".to_string(), font_size: 44.0 },
            point_offset_y: 116.0,
            cta: LayoutParam { x: 105.0, y: 1510.0, width: 850.0, align: "left".to_string(), font_size: 30.0 },
            marker: "- ".to_string(),
        },
        "top_bottom" => LayoutSpec {
            title: LayoutParam { x: 90.0, y: 250.0, width: 900.0, align: "left".to_string(), font_size: 62.0 },
            point: LayoutParam { x: 90.0, y: 1180.0, width: 900.0, align: "left".to_string(), font_size: 50.0 },
            point_offset_y: 94.0,
            cta: LayoutParam { x: 90.0, y: 1510.0, width: 900.0, align: "left".to_string(), font_size: 30.0 },
            marker: "".to_string(),
        },
        "one_word_hook" => LayoutSpec {
            title: LayoutParam { x: 80.0, y: 420.0, width: 920.0, align: "center".to_string(), font_size: 112.0 },
            point: LayoutParam { x: 145.0, y: 760.0, width: 790.0, align: "left".to_string(), font_size: 44.0 },
        ...
        "quote_style" => LayoutSpec {
            title: LayoutParam { x: 90.0, y: 660.0, width: 900.0, align: "center".to_string(), font_size: 72.0 },
            point: LayoutParam { x: 125.0, y: 1080.0, width: 830.0, align: "center".to_string(), font_size: 38.0 },
            point_offset_y: 90.0,
            cta: LayoutParam { x: 110.0, y: 1450.0, width: 860.0, align: "center".to_string(), font_size: 30.0 },
            marker: "".to_string(),
        },
        "story_block" => LayoutSpec {
            title: LayoutParam { x: 90.0, y: 270.0, width: 900.0, align: "left".to_string(), font_size: 62.0 },
            point: LayoutParam { x: 100.0, y: 560.0, width: 880.0, align: "left".to_string(), font_size: 39.0 },
        ...
        "progress_reveal" => LayoutSpec {
            title: LayoutParam { x: 90.0, y: 420.0, width: 900.0, align: "left".to_string(), font_size: 48.0 },
            point: LayoutParam { x: 90.0, y: 770.0, width: 900.0, align: "center".to_string(), font_size: 86.0 },
            point_offset_y: 0.0,
            cta: LayoutParam { x: 110.0, y: 1510.0, width: 860.0, align: "center".to_string(), font_size: 30.0 },
            marker: "".to_string(),
        },
        "center_card" => LayoutSpec {
            title: LayoutParam { x: 100.0, y: 480.0, width: 880.0, align: "center".to_string(), font_size: 64.0 },
            point: LayoutParam { x: 155.0, y: 830.0, width: 770.0, align: "center".to_string(), font_size: 46.0 },
            point_offset_y: 112.0,
            cta: LayoutParam { x: 110.0, y: 1510.0, width: 860.0, align: "center".to_string(), font_size: 30.0 },
            marker: "".to_string(),
        },
        // center_stack
        _ => LayoutSpec {
            title: LayoutParam { x: 90.0, y: 520.0, width: 900.0, align: "center".to_string(), font_size: 78.0 },
            point: LayoutParam { x: 150.0, y: 790.0, width: 780.0, align: "center".to_string(), font_size: 46.0 },
            point_offset_y: 112.0,
            cta: LayoutParam { x: 110.0, y: 1510.0, width: 860.0, align: "center".to_string(), font_size: 30.0 },
            marker: "".to_string(),
        },
